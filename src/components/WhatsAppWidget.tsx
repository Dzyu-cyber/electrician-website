  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3 group">
      ...
      <div className="relative bg-white text-slate-800 font-semibold py-2 px-4 rounded-xl shadow-[0_4px_20px_rgba(0,0,0,0.15)] flex items-center transition-transform duration-300 group-hover:-translate-y-1">
        WhatsApp Us! 😊
        {/* CSS-drawn triangle pointing right */}
      ...
      <a
        ...
        className="flex items-center justify-center w-[60px] h-[60px] rounded-full bg-[#25D366] text-white shadow-[0_4px_20px_rgba(37,211,102,0.4)] transition-transform duration-300 group-hover:scale-110"
        aria-label="Chat with us on WhatsApp"
      >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="w-[34px] h-[34px] fill-current">
